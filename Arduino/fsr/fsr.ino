...
//  p2 = analogRead(fsrPin1);
  ...
  if (p1 >= 100){
    if (sit_temp1 >2){
      ...
      standup1 = 0;
      sit_total1 ++;
      sum_sit_temp1 = String(sit_temp1 / 3600) + ":" + String((sit_temp1 % 3600)/60) + ":"+String(sit_temp1 % 60);
      }   
    sit_temp1 ++;
  }
  //P1 no pressure
    ...
    if(standup1 > 2){
      current1 = "stand";
      sum_standup1 = String(standup1/3600) + ":" + String((standup1 % 3600)/60) + ":"+String(standup1 % 60);
      sit_temp1 = 0; 
      }
    standup1 ++;  
    }
  ...
  //p1 stands up
    ...
    sum_sit_total1 = String(sit_total1 /3600) + ":" + String((sit_total1 % 3600)/ 60) + ":"+String(sit_total1 % 60);
...
//      standup2 = 0;
//      sit_total2 ++;
//      sum_sit_temp2 = String(sit_temp2 /3600) + ":" + String((sit_temp2 % 3600)/ 60) + ":"+String(sit_temp2 % 60);
//      }  
//    sit_temp2 ++;  
//  }
//  //p2 no pressure
...
//       current2 = "stand";
//       sit_temp2 = 0;
//       sum_standup2 = String(standup2/3600) + ":" + String((standup2 % 3600) / 60) + ":"+String(standup2 % 60);
//      }
//    standup2 ++;
//    }
//  //p2 sits down
...
//    sum_sit_total2 = String(sit_total2 /3600) + ":" + String((sit_total2 % 3600) / 60) + ":"+String(sit_total2 % 60);
